...
<svelte:head>
  <link rel="preload" as="image" href="/ping.jpeg" />
...
<style>
  ...
  .gradient {
    ...
    background: radial-gradient(
      ...
      white var(--outer-white-stop),
      white
    );
    transition:
      --inner-white-stop 0.2s ease-in-out,
      --purple-stop 0.2s ease-in-out,
      --outer-white-stop 0.2s ease-in-out;
  }
