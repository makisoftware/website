...
<div class="level-two-container">
    <div class="level-two-text-area">
        <h1>Projects</h1>
        <Project link="https://nileshaw.org/" imagePath="/blossoms.png" title="Blossoms" description="A network as a form of art is emerging from repeated collaboration with the artist Nile Koetting" />
