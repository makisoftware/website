...
<div class="level-two-container">
    <div class="level-two-text-area">
        ...
        <Project
            ...
            imagePath="/t4t.jpeg"
            title="t4t"
            description="Community for trans and gender-non-comforming people"
        />
        <Project
            link="https://pingpractice.org/"
            imagePath="/practice.jpeg"
            title="Ping Practice"
            description="Miniature bits of mindfulness"
        />
        <Project
            link="https://dwelling.makisoftware.com/"
            imagePath="/dwelling.jpeg"
            title="Dwelling"
            description="A social network for your home"
        />
    </div>
</div>
